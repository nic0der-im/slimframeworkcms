...
namespace App\Controllers\Campains\PreciosMundiales;
...
class PreciosMundialesController extends Controller 
{	
	public function getIndex($request, $response, array $args)
	{
		...
		return $this->container->view->render($response, 'guest_views/campains/preciosmundiales/index.twig', [			
