...
firebase.initializeApp({
  'messagingSenderId': '525616032488'
});
...
function showNotification(message) { 
  ...
  const notificationTitle = 'Notificación de Ciro:';
  ...
  const notificationOptions = {
    ...
    icon: 'logo-push.jpg',
    data: {
      click_url: 'https://ciroautomotores.com.ar/administracion/prospectos/listado-prospectos'          
    },
    tag: Date.now()
  };
